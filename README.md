...
- [JQuery](https://jquery.com/) used for user interaction on the how to play off canvas bar again implemented through the bootstrap framework.
...
| [web-dev-simplified](https://www.youtube.com/watch?v=R1S_NhKkvGA) | game.js | tutorial on how to make a text based rpg game |
| [LMS](https://youtu.be/xA6Vp1RppWc) | sendEmail.js | emailjs api |
| [LMS](https://youtu.be/0Qs7RbaCwB4) | sendEmail.js | emailjs api |
| [LMS](https://youtu.be/dUOMEGVcX8Y) | sendEmail.js | emailjs api |
| [LMS](https://youtu.be/6ikltjDtgeQ) | sendEmail.js | emailjs api |
| [LMS](https://youtu.be/KaAeh4Risrc) | sendEmail.js | emailjs api |
| [stack-overflow](https://stackoverflow.com/questions/31106189/create-a-simple-10-second-countdown) | countdown.js | ten second countdown timer |

### Media

I will show here where I got my media files from that I used in the site.
...
- I would like to thank my partner (Sara), for believing in me, helping where she can and allowing me to make this transition into software development.
